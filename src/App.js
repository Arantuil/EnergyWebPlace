    ...
    <div className='bg-[#333] flex justify-center items-center min-h-[100vh] py-6'>
      {blockchain.account === "" || blockchain.smartContract === null ? (
        <div>
          ...
          <h2 className='text-white text-xl flex text-center justify-center mb-4'>Connect to the {CONFIG.NETWORK.NAME} network</h2>
          <button className='flex text-3xl font-semibold text-center mx-auto
            ...
            <div className='bg-white rounded-md flex flex-row py-1 pl-2 pr-3'>
          ...
          {blockchain.errorMsg !== "" ? (
            <>
              <h2 className='mt-1 text-lg text-white md:text-xl flex text-center justify-center'>{blockchain.errorMsg}</h2>
            </>
          ) : null}
        </div>
      ) : (
